...
backward(network,traindata,traindata.instance,learningrate,4000)
backward(network,traindata,traindata.instance,0.05,3000)
backward(network,traindata,traindata.instance,0.03,2000)
backward(network,traindata,traindata.instance,0.01,1000)
